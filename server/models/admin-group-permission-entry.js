...
module.exports = function (sequelize, DataTypes){
    ...
    const AdminGroupPermissionEntry = sequelize.define('AdminGroupPermissionEntry', {
        id: {
            primaryKey: true,
        ...
        classMethods: {
            associate: function (db) {
                ...
                AdminGroupPermissionEntry.belongsTo(db.AdminGroup, { foreignKey: 'admin_group_id' });
                AdminGroupPermissionEntry.belongsTo(db.Permission, { foreignKey: 'permission_id' });
            },
    ...
    return AdminGroupPermissionEntry;
};
