...
var Store = require('../../../../../client/pages/login/stores/Reset');
...
lab.experiment('Login Reset Store', function () {
    ...
    lab.test('it handles a RESET action', function (done) {

        Dispatcher.handleAction(ActionTypes.RESET, {});
    ...
    lab.test('it handles a RESET_RESPONSE action (success)', function (done) {

        Dispatcher.handleAction(ActionTypes.RESET_RESPONSE, {});
    ...
    lab.test('it handles a RESET_RESPONSE action (validation errors)', function (done) {
    ...
    lab.test('it handles a RESET_RESPONSE action (other error)', function (done) {
