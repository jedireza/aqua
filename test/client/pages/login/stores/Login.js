...
var Store = require('../../../../../client/pages/login/stores/Login');
...
lab.experiment('Login Login Store', function () {
    ...
    lab.test('it handles a LOGIN action', function (done) {

        Dispatcher.handleAction(ActionTypes.LOGIN, {});
    ...
    lab.test('it handles a LOGIN_RESPONSE action (success)', function (done) {

        Dispatcher.handleAction(ActionTypes.LOGIN_RESPONSE, {});
    ...
    lab.test('it handles a LOGIN_RESPONSE action (validation errors)', function (done) {
    ...
    lab.test('it handles a LOGIN_RESPONSE action (other error)', function (done) {
