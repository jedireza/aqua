...
var Form = Proxyquire('../../../../../../client/pages/account/components/settings/UserForm.react', {
...
lab.experiment('Account Settings User Form', function () {
    ...
    lab.test('it handles a submit event', function (done) {
        ...
        stub.Actions.saveUserSettings = function () {
