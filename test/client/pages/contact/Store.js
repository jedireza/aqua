...
var Store = require('../../../../client/pages/contact/Store');
...
lab.experiment('Contact Store', function () {
    ...
    lab.test('it handles a SEND_MESSAGE action', function (done) {

        Dispatcher.handleAction(ActionTypes.SEND_MESSAGE, {});
    ...
    lab.test('it handles a SEND_MESSAGE_RESPONSE action (success)', function (done) {

        Dispatcher.handleAction(ActionTypes.SEND_MESSAGE_RESPONSE, {});
    ...
    lab.test('it handles a SEND_MESSAGE_RESPONSE action (validation errors)', function (done) {
    ...
    lab.test('it handles a SEND_MESSAGE_RESPONSE action (other error)', function (done) {
