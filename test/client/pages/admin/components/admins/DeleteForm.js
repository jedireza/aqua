...
var Form = Proxyquire('../../../../../../client/pages/admin/components/admins/DeleteForm.jsx', {
...
lab.experiment('Admin Admin Delete Form', function () {
    ...
    lab.test('it prevents event propagation when confirm returns false', function (done) {
        ...
        FormEl = React.createElement(FormWithContext, Object.assign({}, form.props, {
            details: {
                _id: 'pivot-name'
            }
        }));
