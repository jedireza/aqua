...
var Form = Proxyquire('../../../../../../client/pages/admin/components/admin-groups/CreateNewForm.jsx', {
...
lab.experiment('Admin Admin Group Create New Form', function () {
    ...
    lab.test('it focuses when receiving new props where show is true', function (done) {
        ...
        FormEl = React.createElement(FormWithContext, mockProps);
