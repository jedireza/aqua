...
var Results = require('../../../../../../client/pages/admin/components/users/Results.react');
...
lab.experiment('Admin User Results', function () {
    ...
    lab.test('it renders with data', function (done) {
        ...
        var mockProps = {
            data: [{ _id: '1D', isActive: true }, { _id: '2D', isActive: false }]
        };
