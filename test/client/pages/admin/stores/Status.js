...
var Store = require('../../../../../client/pages/admin/stores/Status');
...
lab.experiment('Admin Status Store', function () {
    ...
    lab.test('it handles a GET_DETAILS_RESPONSE action', function (done) {
        ...
        Code.expect(state._id).to.equal('pivot-name');
        Code.expect(state.pivot).to.equal('Pivot');
