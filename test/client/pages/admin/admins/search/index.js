...
const Store = require('../../../../../../client/pages/admin/admins/search/store');
...
const Page = Proxyquire('../../../../../../client/pages/admin/admins/search/index.jsx', {
...
lab.experiment('Admin Admins Search Page', () => {
