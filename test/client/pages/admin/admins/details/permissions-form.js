...
const Form = Proxyquire('../../../../../../client/pages/admin/admins/details/permissions-form.jsx', {
...
lab.experiment('Admin Admins Permissions Form', () => {
    ...
    lab.test('it handles adding a new permission (only when one is supplied, with a button click or enter key)', (done) => {
        ...
        Code.expect(form.state.permissionEntries).to.have.length(0);
