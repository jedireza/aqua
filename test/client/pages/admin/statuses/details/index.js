...
const Constants = require('../../../../../../client/pages/admin/statuses/details/constants');
...
const Page = Proxyquire('../../../../../../client/pages/admin/statuses/details/index.jsx', {
...
lab.experiment('Admin Statuses Details Page', () => {
    ...
    lab.test('it renders with hydrated state', (done) => {
        ...
        defaultProps.ref.impl = function (page) {
            ...
            Code.expect(heading.textContent).to.include('Happy');
