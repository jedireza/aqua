...
const Form = Proxyquire('../../../../../../client/pages/admin/statuses/search/create-new-form.jsx', {
...
lab.experiment('Admin Statuses Create New Form', () => {
    ...
    lab.test('it focuses on the pivot field when the component is update and showing', (done) => {
        ...
        defaultProps.ref.impl = function (form) {
            ...
            form.els.pivot.input.onfocus = function () {
